...
#         data = JSONParser().parse(request)
#         serializer = SnippetSerializer(snippet_detail, data=data)
#         if serializer.is_valid():
#             serializer.save()
#             return JsonResponse(serializer.data)
#         return JsonResponse(serializer.errors, status=400)
...
########################################################
#Refactoring the above code using DRF views and Response
########################################################
...
"""
Refactoring Views . I will be using APIView , the class based view approach
"""
...
#     """Retrieve , delete or update a Snippet instance"""
